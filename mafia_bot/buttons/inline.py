...
def start_inline_btn():
    keyboard1 = InlineKeyboardButton(text= "ℹ️ Rollar haqida ma'lumot",url="https://t.me/UzbekskayaMafia_Roles")
    keyboard2 = InlineKeyboardButton(text="☑️ Botni guruhga qo'shish haqida ma'lumot",url="https://t.me/UzbekskayaMafia_Roles")
